 ...
 *
 * Vertex AI Express varijanta — koristi API key na aiplatform.googleapis.com endpoint.
 * Model: gemini-2.5-flash-lite
 *
 * Primjer pokretanja:
 *   node generate_article_vertexai_express.js --file /path/to/transcript.srt --gemini-key TVOJ_KLJUC
 */
...
// Vertex AI Express endpoint (API key auth)
const GEMINI_API_BASE = "https://aiplatform.googleapis.com/v1/publishers/google/models";
