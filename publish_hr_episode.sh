...
node generate_channel_index.js --channel "$CH" 2>&1 | grep -iE "muzevni|Ukupno|index.json" | head -3
node upload_to_r2.js --meta-dir storage/meta 2>&1 | grep -iE "muzevni_budite.json|index.json|index_bundle|Neuspjel" | head -5
